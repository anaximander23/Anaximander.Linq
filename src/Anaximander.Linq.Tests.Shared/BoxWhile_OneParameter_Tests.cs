...
{
    public class BoxWhile_OneParameter_Tests
    {
        [Fact]
        public void GivenNullCollection_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => collection.BoxWhile(next => true).ToList());
        }
        ...
        public void GivenEmptyCollection_ReturnsEmptyCollection()
        {
            ...
            var result = collection.BoxWhile(next => true).ToList();
        ...
        public void GivenSingleElement_ReturnsSourceCollectionAsOnlyElement()
        {
            ...
            int[][] result = collection.BoxWhile(next => true)
                .Select(x => x.ToArray())
                .ToArray();
        ...
        public void GivenSingleChangeInCondition_ReturnsTwoCollections()
        {
            ...
            int[][] result = collection.BoxWhile(next => next % 2 == 0)
                .Select(x => x.ToArray())
                .ToArray();
